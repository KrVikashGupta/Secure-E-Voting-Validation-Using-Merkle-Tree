...
// Read Name from CSV using registration number
...
// Pretty print Merkle Tree with hierarchy
...
int main() {
    ...
    cout << "======================================="<<endl;
    cout << "|----------E-Voting Verifier----------|"<<endl;
    cout << "======================================="<<endl;

    // Step 1: Get registration number and find name37
    string regNumber;
    cout << "Enter Registration Number: ";
    cin >> regNumber;
    cout << "\n->Verification process initiated........."<<endl;
    ...
    // Step 3: Display Merkle Tree
    cout << "\n->Merkle Tree Structure:\n";
    printTree(root);
    cout << "\nRoot Hash: " << root->hash << endl;

    // Step 4: Verify Registration Number in Tree
